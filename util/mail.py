...
host = 'smtp.jszyfz.com'  # 设置发件服务器地址
port = 25  # 设置发件服务器端口号。注意，这里有SSL和非SSL两种形式
sender = 'zhanglin@jszyfz.com'  # 设置发件邮箱，一定要自己注册的邮箱
pwd = 'xhwl20170327'  # 设置发件邮箱的密码，等会登陆会用到
receiver = 'zhanglin@jszyfz.com' # 设置邮件接收人，这里是我的公司邮箱
